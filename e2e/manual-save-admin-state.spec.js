...
test('manual assisted: save admin state', async ({ page, context }) => {
  await page.goto(`${BASE}/login`, { waitUntil: 'domcontentloaded', timeout: 30000 });

  // Manual checkpoint: user completes admin login in headed browser, then clicks Resume in Playwright Inspector.
  await page.pause();
