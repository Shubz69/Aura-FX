/** Session payload when leaving checklist for Trade Calculator / journal save */
export const VALIDATOR_CHECKLIST_PENDING_KEY = 'aura-validator-checklist-pending';
...
/** Market Decoder → Trader Lab handoff (full brief JSON + symbol). */
export const MARKET_DECODER_LAB_HANDOFF_KEY = 'aura-market-decoder-lab-handoff';
