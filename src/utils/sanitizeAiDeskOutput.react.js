/**
 * Browser bundle entry for Trader Desk sanitization (single self-contained module).
 * Duplicates `sanitizeAiDeskOutput.mjs` so webpack never drops re-exports across chunks.
 * Keep logic in sync with `sanitizeAiDeskOutput.mjs` and `sanitizeAiDeskOutput.js` (Node).
 */
