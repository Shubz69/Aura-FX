/**
 * Market Decoder — instrument-aware price / metric display (shared: React + Node compose).
 * Trims meaningless trailing zeros; preserves precision where the asset class needs it.
 */
