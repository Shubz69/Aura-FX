    ...
    <div style={{ position: "contents" }}>
      ...
      <div className={`mobile-menu ${mobileMenuOpen ? "active" : ""}`}>
        ...
        <ul className="mobile-nav-links">
          ...
          {!user && (
            <li>
              <Link to="/why-glitch" onClick={closeMobileMenu}>
                Why AURA FX
              </Link>
            </li>
          )}
          ...
          {user && isPremium(user) && (
            <li>
              <Link to="/premium-ai" onClick={closeMobileMenu}>
                🤖 Premium AI
              </Link>
            </li>
          )}
        ...
        <div className="mobile-buttons">
          {!user ? (
            <>
              ...
              <button
                className="mobile-start-trading"
                onClick={() => {
                  navigate("/register");
                  closeMobileMenu();
                }}
      ...
      {user && (
        <div
          className={`mobile-user-menu ${mobileUserMenuOpen ? "active" : ""}`}
        >
          <button
            className="mobile-user-menu-close"
            onClick={toggleMobileUserMenu}
          >
            <FaTimes />
          </button>
    ...
    <>
      <nav className="navbar">
        ...
        <ul className="nav-links">
          ...
          {!user && (
            <li>
              <Link to="/why-glitch">Why Aura FX</Link>
            </li>
          )}
          <li>
                    ...
                    >
                      ...
                      >
                        ...
                        <Link
                          ...
                          onClick={() => setDropdownOpen(false)}
                        >
                          <FaChartLine className="dropdown-icon" /> Aura
                          Analysis
                        </Link>
                        <Link
                          to="/trader-deck"
                        ...
                        {showSuperAdminLinks && (
                          <>
                            ...
                            <Link
                              ...
                              onClick={() => setDropdownOpen(false)}
                            >
                              <FaHeadset className="dropdown-icon" /> Contact
                              Submissions
                            </Link>
                          </>
                        )}
