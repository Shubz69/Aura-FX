      ...
      const functions = [
        {
          ...
          description: 'MANDATORY: Fetch REAL-TIME market data for ANY trading instrument from multiple sources (Alpha Vantage, Yahoo Finance, Finnhub, Twelve Data, Metal API). For gold (XAUUSD), this function prioritizes the most accurate real-time spot prices from Finnhub (OANDA) and Metal API to match TradingView accuracy. You MUST call this function whenever a user asks about ANY instrument price, "where will X go", market data, gaps, price moves, or wants a trade. Works for: stocks (AAPL, TSLA), forex (EURUSD, GBPUSD), crypto (BTCUSD, ETHUSD), commodities (XAUUSD, XAGUSD, Oil), indices (SPY, QQQ), bonds, and more. Returns current price, volume, change, high, low, and market metrics. DO NOT respond about prices without calling this function first. NEVER say "I can\'t access price data" - you MUST call this function. The price returned is the most accurate real-time price available.',
          parameters: {
            type: 'object',
            properties: {
              symbol: {
