...
rl.question('Enter password for slutherfx@gmail.com: ', async (password) => {
...
ON DUPLICATE KEY UPDATE 
    ...
    console.log('========================================');
    console.log('Email: slutherfx@gmail.com');
    console.log(`Password: ${password}`);
    console.log('\nIMPORTANT: Save these credentials securely!');
    console.log('Run this SQL in MySQL Workbench after importing database_schema.sql\n');
